...
<div id="block-random-tovar">
  <ul>
    <?php $query_random = mysqli_query($link, "SELECT DISTINCT * FROM table_products WHERE visible='1' ORDER by RAND() LIMIT 4");
    ...
    <li>
      ...
      <div class="random-content-box">
        ...
        <a class="random-add-cart" tid="'.$res_query["products_id"].'">Купить</a>
      </div>
    </li>
    ';
